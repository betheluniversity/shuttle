...
class DriverLogsController:
    ...
    def grab_logs(self):
        all_shuttle_logs = logs_db.get_shuttle_logs()
        date = 0
        date_list = []
    ...
    def grab_selected_logs(self, date, sort):
        if sort:
            all_shuttle_logs = logs_db.get_shuttle_logs_by_username(date)
        else:
            all_shuttle_logs = logs_db.get_shuttle_logs_by_date(date)
        shuttle_logs = {}
        break_logs = {}
        shuttle_iter = 0
        break_iter = 0
